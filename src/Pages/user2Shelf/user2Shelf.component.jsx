  ...
  return (
    <div>
        ...
        {books.map((bookInfo) => {
          return (
            <div>
            {bookInfo.exchange && bookInfo.option === 1  ? (<img key = {"imag" + bookInfo.url} className={style} onClick={clickImage} src={bookInfo.url} alt="" />
          ) : null}
            </div>
