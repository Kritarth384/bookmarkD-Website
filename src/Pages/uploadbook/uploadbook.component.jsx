...
function uploadBookPage() {
  ...
  const [stylePost, setStylePost] = useState("postButton");
  ...
  useEffect(() => {
    if(bookName !== "" && authorName !== "" && description !== "" && state !== "" && pincode !== ""){
      console.log("sdifdsf")
      setStylePost("postButton12")
    }
    if(bookName === "" || authorName === "" || description === "" || state === "" || pincode === ""){
      console.log("sdifdsf")
      setStylePost("postButton")
    }
  })
  ...
  return (
    <div>
      ...
      <label className="nameBook">Name of <label style={{color: "#F44336"}}>Book</label></label>
      <input className="bookInput" onChange={(e) => setBookName(e.target.value)}></input>
      <label className="authorName">Name of <label style={{color: "#F44336"}}>Author</label></label>
      ...
      <MenuItem />
      <hr className="edge1" />
      <label className="uploadPhotoName">Upload <label style={{color: "#F44336"}}>5 </label>Photos</label>
      ...
      <Link to="/yourShelf">
        <button className={stylePost} onClick={post}>Post</button>
      </Link >
      <Link to="/yourShelf">
